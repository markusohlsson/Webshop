...
let xxxx: Product[] = [proFliHi, headcover2, headcover3]; // tänker jag fel här?

/* Golfbollar */

let productList: Product[] = [headcover1, headcover2, headcover3, proFliHi];

export function createHTMLForProduct(productList: Product[]) {
