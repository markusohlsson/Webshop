...
hamburgericon?.addEventListener("click", function (event) {
  ...
  let checkoutContainer: HTMLDivElement = document.getElementById("checkoutContainer") as HTMLDivElement;
  ...
  let title2:HTMLHeadingElement = document.createElement("h3") as HTMLHeadingElement;
...
// Shopping Cart 
let cartFormContainer:HTMLDivElement = document.getElementById("checkoutContainer") as HTMLDivElement;
